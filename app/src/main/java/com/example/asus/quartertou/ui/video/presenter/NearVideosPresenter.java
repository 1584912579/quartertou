...
public class NearVideosPresenter extends BasePresenter<NearVideosContract.View> implements NearVideosContract.Presenter {
    private Api api;
    @Inject
    public NearVideosPresenter(Api api) {
        this.api = api;
    }

    @Override
    public void getNearVideosPresenter(String page,String token,String latitude,String longitude) {
        api.getNearVideos( page, token, latitude, longitude)
                ...
                .subscribe(new Observer<HotVideosBean>() {
                    ...
                    public void onNext(HotVideosBean hotVideosBean) {
                        if (mView!=null){
                            mView.getNearVideosSuccess(hotVideosBean);
                        }
                    }
